...
public class SymbolPropertiesDialog extends DialogFragment {
    ...
    private final List<EchelonSymbolModifierSpinnerItem> oEchelonMainList = new java.util.ArrayList<>();
    private final List<EchelonSymbolModifierSpinnerItem> oEchelonUnitList = new java.util.ArrayList<>();
    private final List<EchelonSymbolModifierSpinnerItem> oEchelonInstallationList = new java.util.ArrayList<>();
    private final List<EchelonSymbolModifierSpinnerItem> oEchelonMobilityList = new java.util.ArrayList<>();
    private final List<EchelonSymbolModifierSpinnerItem> oEchelonTowedArrayList = new java.util.ArrayList<>();
    private List<EchelonSymbolModifierSpinnerItem> oEchelonCurrentList = null;
