...
public class TacticalGraphicPropertiesDialog extends DialogFragment {
    ...
    private static final java.util.HashMap<org.cmapi.primitives.GeoMilSymbol.SymbolStandard, TacticalGraphicSymbolTable> oSymbolTableList =
    ...
    public armyc2.c2sd.renderer.utilities.SymbolDef getCurrentDef() {
    ...
    private void loadSymbolCodeList() {
        int iIndex = 0;
        armyc2.c2sd.renderer.utilities.SymbolDef oDef;
        ...
        oDef = new armyc2.c2sd.renderer.utilities.SymbolDef("***************",
