...
public class StorageManager implements IStorageManager {
    ...
    */
     ...
     * is visible. It saves processing of going through the steps to find the values
     * of mapInstance and visible, as in the second apply method below.  Also the
     * editor changes apply immediately and are never processed in a batch.
     *
