 ...
 */
public class Vec4 {
    final static private String TAG = Vec4.class.getSimpleName();
    ...
    public static Vec4 fromDoubleArray(double[] array, int offset, int length) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "fromDoubleArray", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (offset < 0) {
            String msg = Logger.makeMessage(TAG, "fromDoubleArray", "generic.OffsetIsInvalid " + offset);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (length < 1) {
            String msg = Logger.makeMessage(TAG, "fromDoubleArray", "generic.LengthIsInvalid " + length);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (array.length < offset + length) {
            String msg = Logger.makeMessage(TAG, "fromDoubleArray", "generic.ArrayInvalidLength " + array.length);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 fromFloatArray(float[] array, int offset, int length) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "fromFloatArray", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (offset < 0) {
            String msg = Logger.makeMessage(TAG, "fromFloatArray", "generic.OffsetIsInvalid " + offset);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (length < 1) {
            String msg = Logger.makeMessage(TAG, "fromFloatArray", "generic.LengthIsInvalid " + length);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (array.length < offset + length) {
            String msg = Logger.makeMessage(TAG, "fromFloatArray", "generic.ArrayInvalidLength " + array.length);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 fromArray2(double[] array, int offset) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "fromArray2", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 fromArray3(double[] array, int offset) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "fromArray3", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 fromArray4(double[] array, int offset) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "fromArray4", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double[] toDoubleArray(double[] array, int offset, int length) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "toDoubleArray", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (offset < 0) {
            String msg = Logger.makeMessage(TAG, "toDoubleArray", "generic.OffsetIsInvalid " + offset);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (length < 1) {
            String msg = Logger.makeMessage(TAG, "toDoubleArray", "generic.LengthIsInvalid " + length);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (array.length < offset + length) {
            String msg = Logger.makeMessage(TAG, "toDoubleArray", "generic.ArrayInvalidLength " + array.length);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final float[] toFloatArray(float[] array, int offset, int length) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "toFloatArray", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (offset < 0) {
            String msg = Logger.makeMessage(TAG, "toFloatArray", "generic.OffsetIsInvalid " + offset);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (length < 1) {
            String msg = Logger.makeMessage(TAG, "toFloatArray", "generic.LengthIsInvalid " + length);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (array.length < offset + length) {
            String msg = Logger.makeMessage(TAG, "toFloatArray", "generic.ArrayInvalidLength " + array.length);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double[] toArray2(double[] array, int offset) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "toArray2", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double[] toArray3(double[] array, int offset) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "toArray3", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double[] toArray4(double[] array, int offset) {
        if (array == null) {
            String msg = Logger.makeMessage(TAG, "toArray4", "nullValue.ArrayIsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 fromLine3(Vec4 origin, double t, Vec4 direction) {
        if (origin == null || direction == null) {
            String msg = Logger.makeMessage(TAG, "fromLine3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final Vec4 add3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "add3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final Vec4 subtract3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "subtract3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final Vec4 multiply3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "multiply3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final Vec4 divide3(double value) {
        if (value == 0) {
            String msg = Logger.makeMessage(TAG, "divide3", "generic.ArgumentOutOfRange " + value);
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final Vec4 divide3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "divide3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double distanceTo2(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "distanceTo2", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double distanceTo3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "distanceTo3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double distanceToSquared3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "distanceToSquared3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double dot3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "dot3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double dot4(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "dot4", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final Vec4 cross3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "cross3", "nullValue.Vec4IsNull");
            ////Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final double angleBetween3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "angleBetween3", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
        ...
        return Math.toDegrees(Math.acos(a_dot_b));
    }
     ...
     */
    public static double axisAngle(Vec4 v1, Vec4 v2, Vec4[] result) {
        if (v1 == null || v2 == null) {
            String msg = Logger.makeMessage(TAG, "axisAngle", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (result == null) {
            String msg = Logger.makeMessage(TAG, "axisAngle", "nullValue.ArrayIsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
        ...
        double angle = Math.toDegrees(Math.acos(u0.x * u1.x + u0.y * u1.y + u0.z * u1.z));
    ...
    public final Vec4 projectOnto3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "projectOnto3", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final Vec4 perpendicularTo3(Vec4 vec4) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "perpendicularTo3", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public final Vec4 transformBy3(Matrix4 matrix) {
        if (matrix == null) {
            String msg = Logger.makeMessage(TAG, "transformBy3", "nullValue.MatrixIsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
        ...
        return new Vec4((matrix.m[0] * this.x) + (matrix.m[1] * this.y) + (matrix.m[2] * this.z), (matrix.m[4] * this.x) + (matrix.m[5] * this.y) + (matrix.m[6] * this.z), (matrix.m[8] * this.x) + (matrix.m[9] * this.y) + (matrix.m[10] * this.z));
    }
/*
    public final Vec4 transformBy3(Quaternion quaternion) {
        if (quaternion == null) {
            String msg = Logger.makeMessage(TAG, "transformBy3", "nullValue.QuaternionIsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
...
*/
    public final Vec4 transformBy4(Matrix4 matrix) {
        if (matrix == null) {
            String msg = Logger.makeMessage(TAG, "transformBy4", "nullValue.MatrixIsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 min3(Vec4 value1, Vec4 value2) {
        if ((value1 == null) || (value2 == null)) {
            String msg = Logger.makeMessage(TAG, "min3", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 max3(Vec4 value1, Vec4 value2) {
        if ((value1 == null) || (value2 == null)) {
            String msg = Logger.makeMessage(TAG, "max3", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 clamp3(Vec4 vec4, double min, double max) {
        if (vec4 == null) {
            String msg = Logger.makeMessage(TAG, "clamp3", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 mix3(double amount, Vec4 value1, Vec4 value2) {
        if ((value1 == null) || (value2 == null)) {
            String msg = Logger.makeMessage(TAG, "mix3", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4 computeAveragePoint(Iterable<? extends Vec4> points) {
        if (points == null) {
            String msg = Logger.makeMessage(TAG, "computeAveragePoint", "nullValue.PointListIsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
...
/*
    public static Vec4 computeAveragePoint3(BufferWrapper coordinates, int stride) {
        if (coordinates == null) {
            String msg = Logger.makeMessage(TAG, "computeAveragePoint3", "nullValue.CoordinatesAreNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }

        if (stride < 3) {
            String msg = Logger.makeMessage(TAG, "computeAveragePoint3", "generic.StrideIsInvalid");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
...
*/
    public static double getAverageDistance(Iterable<? extends Vec4> points) {
        if ((points == null)) {
            String msg = Logger.makeMessage(TAG, "getAverageDistance", "nullValue.PointListIsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Vec4[] computeExtrema(Vec4 points[]) {
        if (points == null) {
            String message = Logger.makeMessage(TAG, "computeExtrema", "nullValue.PointsArrayIsNull");
...
/*
    public static Vec4[] computeExtrema(BufferWrapper buffer) {
        if (buffer == null) {
            String message = Logger.makeMessage(TAG, "computeExtrema", "nullValue.BufferIsNull");
            //Logging.logger().severe(message);
            throw new IllegalArgumentException(message);
        }
...
*/
    ...
    public static boolean areColinear(Vec4 a, Vec4 b, Vec4 c) {
        if (a == null || b == null || c == null) {
            String msg = Logger.makeMessage(TAG, "areColinear", "nullValue.Vec4IsNull");
            //Logging.logger().severe(msg);
            throw new IllegalArgumentException(msg);
        }
