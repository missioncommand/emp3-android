...
{
    final static private String TAG = AVListImpl.class.getSimpleName();
    ...
    synchronized public Object getValue(String key)
    {
        if (key == null)
        {
            String message = Logger.makeMessage(TAG, "getValue", "nullValue.AttributeKeyIsNull");
    ...
    synchronized public String getStringValue(String key)
    {
        if (key == null)
        {
            String msg = Logger.makeMessage(TAG, "getStringValue", "nullValue.AttributeKeyIsNull");
        ...
        {
            String msg = Logger.makeMessage(TAG, "getStringValue", "AVAAccessibleImpl.AttributeValueForKeyIsNotAString" + key);
            Logger.log(Logger.ERROR, msg);
    ...
    synchronized public Object setValue(String key, Object value)
    {
        if (key == null)
        {
            String message = Logger.makeMessage(TAG, "isDrawGraticule", "nullValue.AttributeKeyIsNull");
            Logger.log(Logger.ERROR, message);;
            throw new IllegalArgumentException(message);
        }
    ...
    synchronized public AVList setValues(AVList list)
    {
        if (list == null)
        {
            String message = Logger.makeMessage(TAG, "isDrawGraticule", "nullValue.AttributesIsNull");
            Logger.log(Logger.ERROR, message);;
            throw new IllegalArgumentException(message);
        }
    ...
    synchronized public boolean hasKey(String key)
    {
        if (key == null)
        {
            String message = Logger.makeMessage(TAG, "isDrawGraticule", "nullValue.KeyIsNull");
            Logger.log(Logger.ERROR, message);;
            throw new IllegalArgumentException(message);
        }
    ...
    synchronized public void addPropertyChangeListener(String propertyName, java.beans.PropertyChangeListener listener)
    {
        ...
        {
            String msg = Logger.makeMessage(TAG, "isDrawGraticule", "nullValue.PropertyNameIsNull");
            Logger.log(Logger.ERROR, msg);
            throw new IllegalArgumentException(msg);
        }
        if (listener == null)
        {
            String msg = Logger.makeMessage(TAG, "isDrawGraticule", "nullValue.ListenerIsNull");
            Logger.log(Logger.ERROR, msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public void firePropertyChange(java.beans.PropertyChangeEvent propertyChangeEvent)
    {
        ...
        {
            String msg = Logger.makeMessage(TAG, "isDrawGraticule", "nullValue.PropertyChangeEventIsNull");
            Logger.log(Logger.ERROR, msg);
            throw new IllegalArgumentException(msg);
        }
    ...
    public static Integer getIntegerValue(AVList avList, String key)
    {
        ...
        {
            Logger.log(Logger.ERROR, "Configuration.ConversionError");
            return null;
        }
    }
...
/*
        ...
        RestorableSupport.StateObject context)
    {
        ...
        if (rs == null)
        {
            String message = Logger.makeMessage(TAG, "isDrawGraticule", "nullValue.RestorableStateIsNull");
            Logger.log(Logger.ERROR, message);;
            throw new IllegalArgumentException(message);
        }
