 ...
 */
public class KmlPoint implements KmlGeometry<IGeoPosition> {

    public static final String GEOMETRY_TYPE = "Point";

    private final IGeoPosition mCoordinate;
     ...
     */
    public KmlPoint(IGeoPosition coordinate) {
        if (coordinate == null) {
     ...
     */
    public IGeoPosition getGeometryObject() {
        return mCoordinate;
    }
