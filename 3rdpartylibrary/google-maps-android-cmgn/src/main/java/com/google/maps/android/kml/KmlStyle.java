...
*/
    ...
    private IGeoColor fillColor = null;

    private boolean mOutline = true;

    private IGeoColor strokeColor = null;
    ...
    private float xHotSpot = 0;
    private float yHotSpot = 0;
    ...
    public boolean hasFill() {
        return (this.fillColor != null) && this.mFill;
    }
    ...
    /* package */ void setFillColor(String color) {
        ...
        int colorInt = Color.parseColor("#" + convertColor(color));
        this.fillColor = new GeoColor();
        this.fillColor.setAlpha(Color.alpha(colorInt));
        this.fillColor.setRed(Color.red(colorInt));
        this.fillColor.setGreen(Color.green(colorInt));
        this.fillColor.setBlue(Color.blue(colorInt));
    ...
    /* package */ void setHotSpot(float x, float y, String xUnits, String yUnits) {
        ...
        this.xHotSpot = xAnchor;
        this.yHotSpot = yAnchor;
    ...
    /* package */ void setOutlineColor(String color) {
        // Add # to allow for mOutline color to be parsed correctly
        int colorInt = Color.parseColor("#" + convertColor(color));
        this.strokeColor = new GeoColor();
        this.strokeColor.setAlpha(Color.alpha(colorInt));
        this.strokeColor.setRed(Color.red(colorInt));
        this.strokeColor.setGreen(Color.green(colorInt));
        this.strokeColor.setBlue(Color.blue(colorInt));
...
*/
    ...
    public IGeoColor getFillColor() {
        return this.fillColor;
    }

    public IGeoColor getStrokeColor() {
